                   ...
                   <div class="icon">
                    ...
                    <div  id="des3" class="description2">
                     ...
                     <div id="des4" className="description">
                        ...
                        <div class="dismiss-btn" >
                            <button id="dismiss-popup-btn" onClick={() =>{DeleteOne(A)}}/*{DeleteOne(Id)}*/>
                             Yes
                            </button>
                   ...
                   <div id="des6" class="description1">
                       <form autocomplete="off" onSubmit={()=>{UpdateAcc(A)}} >
                                   ...
                                   <div class="title">
                                    ...
                                    <div class="dismiss-btn" >
                                   <button type="reset"  id="botona" className="dismiss" style={{background: toggle? "white" : "#ff6701"}} value="C_EQ" onClick={(e) =>{ setType(e.currentTarget.value); settoggle(true); settoggle1(false)/*document.getElementById(e.currentTarget.value).classList.toggle('active2'); document.getElementById(e.currentTarget.value).classList.toggle('dismiss');*/ }}>
                                    Chef equipe
                                    </button >
                                    <button type="reset" id="botona1" className="dismiss" style={{background: toggle1? "white" : "#ff6701"}} value="PROF" onClick={(e) =>{ setType(e.currentTarget.value); settoggle1(true); settoggle(false)/*document.getElementById(e.currentTarget.value).classList.toggle('active2'); document.getElementById(e.currentTarget.value).classList.toggle('dismiss'); */}}>
                                    Prof
                                    </button > 
                             </div>
