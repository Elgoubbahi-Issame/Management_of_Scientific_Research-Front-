        ...
        <div className="body">
            ...
            <div class="popup center">
                   ...
                   <div class="icon">
                    ...
                    <div class="dismiss-btn d-flex justify-content-center" >
                   ...
                   <div id="des6" class="description1">
                       <form autocomplete="off" onSubmit={()=>{UpdateAcc(A)}} >
                                   ...
                                   {/* <div class="title">
                                    ...
                                    <div class="dismiss-btn" >
                                   <a   id="botona" className="dismiss" style={{background: toggle? "white" : "#ff6701"}} value="C_EQ" onClick={(e) =>{ setType(e.currentTarget.value); settoggle(true); settoggle1(false) }}>
                                    Chef equipe
                                    </a>
                                    <a  id="botona1" className="dismiss" style={{background: toggle1? "white" : "#ff6701"}} value="Prof" onClick={(e) =>{ setType(e.currentTarget.value); settoggle1(true); settoggle(false)}}>
                                    Prof
                                    </a> 
                             </div> */}
